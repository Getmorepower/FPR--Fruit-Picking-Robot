...
- ![confusion_matrix_normalized_original](./Result/confusion_matrix_normalized_30percentpruned+selecteddata*.png) — ![confusion_matrix_normalized_original](./Result/confusion_matrix_normalized_*.png)  per-cultivar confusion
